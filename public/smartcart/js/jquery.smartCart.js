(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                // Labels & Messages              
                var labelCartMenuName = 'Book Cart (_COUNT_)';  // _COUNT_ will be replaced with cart count
                var labelCartMenuNameTooltip = "Book Cart | Total Books: _PRODUCTCOUNT_ | Total Quantity: _ITEMCOUNT_";
                var labelProductMenuName = 'Books';
                ...
                var labelProducts = 'Books';
                var labelPrice = 'Availability';
                var labelSubtotal = 'Subtotal';
                var labelTotal = 'Total';
                var labelRemove = 'Remove';
                var labelCheckout = 'Confirm Borrow';
                ...
                var messageProductEmpty = "No books to display";
                var messageProductAddError = "Book cannot add";
                var messageItemAdded = 'Book added to the library cart';
                var messageItemRemoved = 'Book removed from the library cart';
                var messageQuantityUpdated = 'Book quantity updated';
                var messageQuantityErrorAdd = 'Invalid quantity. Book cannot add';
                ...
                function addCartItemDisplay(objProd,Quantity){
                    ...
                    var inputQty = $('<input type="text" value="'+Quantity+'" readonly="true"/>').attr("id","lblQuantity"+pIndex).attr("rel",pIndex).addClass("scTxtQuantity2");                    
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong><br />Category: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Availability: <%=pprice%></strong>',
