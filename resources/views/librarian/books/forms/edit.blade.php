        ...
        <div class="col-md-6">
            <div class="form-group form-float">
                <div class="form-line{{ $errors->first('total_copy') ? ' error' : '' }}">
                    <input type="integer" class="form-control" name="total_copy" value="{{ old('total_copy') ? : $book->total_copy }}">
        ...
        <div class="col-md-6">
            <div class="form-group form-float">
                <div class="form-line{{ $errors->first('available_copy') ? ' error' : '' }}">
                    <input type="integer" class="form-control" name="available_copy" value="{{ old('available_copy') ? : $book->available_copy }}">
    ...
    <div class="row clearfix">
        <div class="col-md-6">
            <div class="form-group form-float">
                <div class="form-line{{ $errors->first('location') ? ' error' : '' }}">
                    <input type="text" class="form-control" name="location" value="{{ old('location') ? : $book->location }}">
        ...
        <div class="col-md-6 text-center">
            <div class="form-group text-center">
                ...
                <input type="reset" class="btn btn-warning btn-lg" value="Reset Book">
            </div>
        </div>
    </div>
</form>